...
<span style="font-size: 25px; font-weight: bold;">
  ...
  NYC AED Coverage & Traffic Flow Insights
</span>

The maps below display AED locations (left-hand side) and average traffic volumes (right-hand side) captured between years 2019 to 2024 across NYC boroughs. Click on the AED icons to explore:

* AED locations
* AED counts
* AED trained personnel.

Interact with the traffic circles to explore: 
...
```{r, include=FALSE}
aed_map <- readRDS("aed_map.rds")
traffic_map <- readRDS("traffic_map.rds")
```
