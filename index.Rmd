...
The maps below display AED locations (top map) and average traffic volumes (bottom map) captured between years 2019 to 2024 across NYC boroughs. Click on the AED icons to explore:
