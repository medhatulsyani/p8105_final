...
### <img src="icons/warning.png" width="40" style="vertical-align:-10px;"> **Linear model for mean traffic volume across boroughs, set Manhattan as reference**
```{r}
...
traffic_linear_model = lm(vol ~ boro, data = traffic_volume_df)
summary(traffic_linear_model)
```
...
### <img src="icons/aed.png" width="40" style="vertical-align:-10px;"> **Linear model for mean AED across boroughs, set Manhattan as reference**
```{r}
...
aed_linear_model = lm(aed_num_aeds ~ borough, data = aed_inventory_df)
summary(aed_linear_model)
```
...
### <img src="icons/browser.png" width="40" style="vertical-align:-10px;"> **Pearson correlation between AED density and mean traffic volume**
...
### <img src="icons/traffic-cone.png" width="40" style="vertical-align:-10px;"> **Derived metric**
```{r}
