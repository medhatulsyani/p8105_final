...
aed_inventory_df <- read_csv(
  "./raw_data/NYC_Automated_External_Defibrillator_(AED)_Inventory.csv"
)

leading_causes_df <- read_csv(
  "./raw_data/NYC_Leading_Causes_of_Death.csv"
)
...
write_csv(traffic_clean, "clean_data/traffic_clean.csv")
...
write_csv(aed_clean, "clean_data/aed_clean.csv")
...
write_csv(leading_clean, "clean_data/leading_causes_clean.csv")